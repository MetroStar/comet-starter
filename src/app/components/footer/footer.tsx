        ...
        <div className="grid-container">
          <div className="grid-row grid-gap">
            ...
            >
              ...
              <div className="mobile-lg:grid-col-auto">
                <p className="usa-footer__logo-heading" style={{ fontSize: '1rem' }}>
                  {APP_TITLE}
                </p>
              </div>
            </div>
              ...
              <div className="usa-footer__social-links grid-row grid-gap-1">
                <div className="grid-col-auto">
                  <a className="usa-social-link" href="/#">
                    <img className="usa-social-link__icon" src={facebookIcon} alt="Facebook" />
                  </a>
                </div>

                <div className="grid-col-auto">
                  <a className="usa-social-link" href="/#">
                    <img className="usa-social-link__icon" src={twitterIcon} alt="Twitter" />
                  </a>
                </div>

                <div className="grid-col-auto">
                  <a className="usa-social-link" href="/#">
                    <img className="usa-social-link__icon" src={youtubeIcon} alt="YouTube" />
                  </a>
                </div>

                <div className="grid-col-auto">
                  <a className="usa-social-link" href="/#">
                    <img className="usa-social-link__icon" src={instagramIcon} alt="Instagram" />
                  </a>
                </div>

                <div className="grid-col-auto">
                  <a className="usa-social-link" href="/#">
                    <img className="usa-social-link__icon" src={rssIcon} alt="RSS" />
                  </a>
                </div>
              </div>
